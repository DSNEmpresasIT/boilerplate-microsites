  ...
  return (
    <section className="relative md:py-60 py-36 items-center">
      <div className="absolute top-0 start-0 w-full h-full z-0 pointer-events-none overflow-hidden">
        <iframe
          src={
            bannerData?.video_link ??
            "https://www.youtube.com/embed/n8YwWZy3bcM?si=crozwWL_ik2hFWJw?controls=0&showinfo=0&rel=0&autoplay=1&loop=1&mute=1"
          }
      ...
      <div className="container relative">
        <div className="grid grid-cols-1 pb-8 text-center mt-10">
          <Image
            src={bannerData?.icon ?? "/images/logo-icon-64.png"}
            width={82}
            height={80}
          ...
          <h3 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 mt-10 text-white">
            {bannerData?.title ?? "Coworking Just Feels Right"}
          </h3>
          <p className="text-slate-300 text-lg max-w-2xl mx-auto">
            {bannerData?.description ??
              "Coworking spaces offer a wealth of advantages for self starters, including networking opportunities, daily structure, and increased productivity."}
          </p>
        </div>
      </div>
    </section>
